...
public class ME02RawData {
    ...
    public static class Car {
        ...
        public static Car parseCar(String text) {
            ...
            Engine engine = new Engine(Integer.parseInt(carsParameters[1]),
                    Integer.parseInt(carsParameters[2]));
            Cargo cargo = new Cargo(Integer.parseInt(carsParameters[3]), carsParameters[4]);

            List<Tire> tires = new ArrayList<>();
            Tire tire = new Tire(Double.parseDouble(carsParameters[5]),
                    Integer.parseInt(carsParameters[6]),
