...
public class ME3CarSalesman {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numberEngine; i++) {
            ...
            CarSalesman.Engine singleEngine = new CarSalesman
        ...
        for (int i = 0; i < numberCars; i++) {
            ...
            for (CarSalesman.Engine engineForCar : engineList) {
            ...
            CarSalesman.Engine engineForThisCar = new CarSalesman
                    .Engine(engineModel, enginePower, engineDisplacement, engineEfficiency);
            CarSalesman.Car singleCar = new CarSalesman.Car(model, engineForThisCar, weight, color);
    ...
    public static class CarSalesman {
        static class Car {
