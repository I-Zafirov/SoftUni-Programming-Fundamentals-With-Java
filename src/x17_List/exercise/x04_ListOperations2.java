...
public class x04_ListOperations2 {
 public static void main(String[] args) {
    ...
    private static void shift(List<Integer> numbers, String[] data, int count) {
    ...
    private static void remove(List<Integer> numbers, String[] data) {
        int index;
