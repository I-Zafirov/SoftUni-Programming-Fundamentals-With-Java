...
public class P3HeroesOfCodeAndLogicVII {
    static class Hero {
        String name;
        int hitPoints;
        int manaPoints;
...
//broke the program
    ...
    private static void handleRecharge(Map<String, Hero> heroes, String heroName, int amount) {
        ...
        int newManaPoints = Math.min(hero.getManaPoints() + amount, 200); // if points bigger from 200 ->  newManaPoints = 200
    ...
    private static void handleHeal(Map<String, Hero> heroes, String heroName, int amount) {
        ...
        int newHitPoints = Math.min(hero.getHitPoints() + amount, 100); // if points bigger from 200 ->  newManaPoints = 200
